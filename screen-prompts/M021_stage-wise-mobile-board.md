...
This is screen completion prompt: M021 — Stage Wise Mobile Board

Platform: Mobile
Module: Dashboards
Primary roles: PlantHead, ManagementViewer
Business purpose: Compact board of blocked/overdue stages
...
- capture screenshots under docs/codex-review-screens/M021/

Required screenshots for this screen:
- m021-screen-top
- m021-screen-lower-if-needed
