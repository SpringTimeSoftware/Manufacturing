...
This is screen completion prompt: W105 — Pack List

Platform: Web
Module: Dispatch
Primary roles: DispatchManager
Business purpose: Packing structure, labels, pack completeness
...
- capture screenshots under docs/codex-review-screens/W105/

Required screenshots for this screen:
- w105-list-top
- w105-list-middle-if-needed
- w105-list-bottom-if-needed
