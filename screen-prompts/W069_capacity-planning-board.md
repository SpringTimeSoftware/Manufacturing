...
This is screen completion prompt: W069 — Capacity Planning Board

Platform: Web
Module: Planning
Primary roles: PlanningManager, PlantHead
Business purpose: RCCP/CRP by machine/work center/shift
...
- capture screenshots under docs/codex-review-screens/W069/

Required screenshots for this screen:
- w069-top
- w069-middle-if-needed
- w069-bottom-if-needed
