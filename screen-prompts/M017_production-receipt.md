...
This is screen completion prompt: M017 — Production Receipt

Platform: Mobile
Module: Production
Primary roles: ProductionSupervisor, StoreKeeper
Business purpose: Receive output with lot/serial/catch-weight
...
- capture screenshots under docs/codex-review-screens/M017/

Required screenshots for this screen:
- m017-screen-top
- m017-screen-lower-if-needed
