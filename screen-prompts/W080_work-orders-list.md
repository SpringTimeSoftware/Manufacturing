...
This is screen completion prompt: W080 — Work Orders List

Platform: Web
Module: Production
Primary roles: PlanningManager, ProductionSupervisor
Business purpose: List, release, re-release, and monitor WOs
...
- capture screenshots under docs/codex-review-screens/W080/

Required screenshots for this screen:
- w080-list-top
- w080-list-middle-if-needed
- w080-list-bottom-if-needed
