...
This is screen completion prompt: M018 — Rework / NCR Capture

Platform: Mobile
Module: Quality
Primary roles: QCInspector, ProductionSupervisor
Business purpose: Create deviation, hold, rework instruction
...
- capture screenshots under docs/codex-review-screens/M018/

Required screenshots for this screen:
- m018-screen-top
- m018-screen-lower-if-needed
