...
This is screen completion prompt: W045 — Customer Detail

Platform: Web
Module: Partners
Primary roles: SalesCoordinator
Business purpose: Contacts, addresses, communication log, customer-specific notes
...
- No dead actions; selectors not free text
...
- capture screenshots under docs/codex-review-screens/W045/

Required screenshots for this screen:
- w045-workspace-overview
- w045-workspace-lower-if-needed
