...
This is screen completion prompt: W060 — BOM Library

Platform: Web
Module: Engineering
Primary roles: PlanningManager, Engineering, PlantHead
Business purpose: Search revisions and statuses of BOMs
...
- capture screenshots under docs/codex-review-screens/W060/

Required screenshots for this screen:
- w060-list-top
- w060-list-middle-if-needed
- w060-list-bottom-if-needed
