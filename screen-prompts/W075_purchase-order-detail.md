...
This is screen completion prompt: W075 — Purchase Order Detail

Platform: Web
Module: Procurement
Primary roles: PurchaseManager
Business purpose: PO detail with receipts, due dates, and outside-processing context
...
- capture screenshots under docs/codex-review-screens/W075/

Required screenshots for this screen:
- w075-workspace-overview
- w075-workspace-lower-if-needed
