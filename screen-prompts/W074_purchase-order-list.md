...
This is screen completion prompt: W074 — Purchase Order List

Platform: Web
Module: Procurement
Primary roles: PurchaseManager
Business purpose: PO list with status, overdue follow-up, and source linkage
...
- capture screenshots under docs/codex-review-screens/W074/

Required screenshots for this screen:
- w074-list-top
- w074-list-middle-if-needed
- w074-list-bottom-if-needed
