...
This is screen completion prompt: M008 — Execution Action Sheet

Platform: Mobile
Module: Production
Primary roles: MachineOperator
Business purpose: Start/pause/resume/complete with reason
...
- capture screenshots under docs/codex-review-screens/M008/

Required screenshots for this screen:
- m008-screen-top
- m008-screen-lower-if-needed
