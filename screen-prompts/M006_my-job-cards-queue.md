...
This is screen completion prompt: M006 — My Job Cards Queue

Platform: Mobile
Module: Production
Primary roles: MachineOperator, ProductionSupervisor
Business purpose: Assigned and nearby job cards ready for action
...
Resolve the actual mobile screen route/navigation key from the current repo. Do not guess.
...
1. KPI strip
2. Filters
3. Execution grid/workspace
4. Posting truth
5. Exception handling
6. Audit/history

Screen-specific fields to verify and complete:
- Determine all visible inputs, selectors, quantities, reason codes, media controls, and offline queue controls from the current screen implementation and correct them using the global field truth rules.

Screen-specific actions to verify and complete:
- Audit every visible action on this screen and enforce WORKING / DISABLED WITH REASON / HIDDEN.
...
- capture screenshots under docs/codex-review-screens/M006/

Required screenshots for this screen:
- m006-screen-top
- m006-screen-lower-if-needed
