...
This is screen completion prompt: W007 — Approval Workbench

Platform: Web
Module: Platform
Primary roles: Managers
Business purpose: Approve BOMs, releases, PO, holds, dispatch, AI drafts
...
- Approval actions must obey workflow state
...
- capture screenshots under docs/codex-review-screens/W007/
