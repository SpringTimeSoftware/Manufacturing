...
This is screen completion prompt: M007 — Job Card Detail

Platform: Mobile
Module: Production
Primary roles: MachineOperator, ProductionSupervisor
Business purpose: Operation context, specs, attachments, required qty
...
- capture screenshots under docs/codex-review-screens/M007/

Required screenshots for this screen:
- m007-screen-top
- m007-screen-lower-if-needed
