...
This is screen completion prompt: W009 — Role & Permission Matrix

Platform: Web
Module: Platform
Primary roles: PlatformAdmin, CompanyAdmin
Business purpose: Role templates, action rights, data scopes
...
- capture screenshots under docs/codex-review-screens/W009/
