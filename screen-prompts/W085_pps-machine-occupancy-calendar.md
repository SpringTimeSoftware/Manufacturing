...
This is screen completion prompt: W085 — PPS Machine Occupancy Calendar

Platform: Web
Module: Production
Primary roles: PlanningManager, PlantHead
Business purpose: Calendar occupancy across machines and days
...
- capture screenshots under docs/codex-review-screens/W085/

Required screenshots for this screen:
- w085-top
- w085-middle-if-needed
- w085-bottom-if-needed
