...
This is screen completion prompt: M016 — QC Checkpoint Entry

Platform: Mobile
Module: Quality
Primary roles: QCInspector, ProductionSupervisor
Business purpose: Pass/fail/measurement/photo capture
...
- capture screenshots under docs/codex-review-screens/M016/

Required screenshots for this screen:
- m016-screen-top
- m016-screen-lower-if-needed
