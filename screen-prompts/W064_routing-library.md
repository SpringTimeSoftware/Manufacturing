...
This is screen completion prompt: W064 — Routing Library

Platform: Web
Module: Engineering
Primary roles: PlanningManager
Business purpose: Reusable routings and operation sequences
...
- capture screenshots under docs/codex-review-screens/W064/

Required screenshots for this screen:
- w064-list-top
- w064-list-middle-if-needed
- w064-list-bottom-if-needed
