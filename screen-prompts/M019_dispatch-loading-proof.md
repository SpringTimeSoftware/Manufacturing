...
This is screen completion prompt: M019 — Dispatch Loading / Proof

Platform: Mobile
Module: Dispatch
Primary roles: DispatchManager
Business purpose: Scan packed items, capture loading proof, seal/vehicle notes
...
1. KPI strip
2. Filters
3. Pack/plan/shipment workspace
4. Proof/doc truth
5. Audit/history
...
- capture screenshots under docs/codex-review-screens/M019/

Required screenshots for this screen:
- m019-screen-top
- m019-screen-lower-if-needed
