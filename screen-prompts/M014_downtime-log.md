...
This is screen completion prompt: M014 — Downtime Log

Platform: Mobile
Module: Production
Primary roles: MachineOperator, ProductionSupervisor
Business purpose: Log machine stop, reason, photo, escalation
...
- capture screenshots under docs/codex-review-screens/M014/

Required screenshots for this screen:
- m014-screen-top
- m014-screen-lower-if-needed
