...
This is screen completion prompt: W108 — Stage Wise Dashboard

Platform: Web
Module: Dashboards
Primary roles: PlantHead, ManagementViewer
Business purpose: Cross-department board from SO confirmed to dispatch
...
- No fake stage cards in live mode
...
- capture screenshots under docs/codex-review-screens/W108/

Required screenshots for this screen:
- w108-top
- w108-middle-if-needed
- w108-bottom-if-needed
