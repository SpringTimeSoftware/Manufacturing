...
This is screen completion prompt: W088 — Production Receipt

Platform: Web
Module: Production
Primary roles: ProductionSupervisor, StoreKeeper
Business purpose: Receive WIP/FG output with lot/serial/catch-weight handling
...
- capture screenshots under docs/codex-review-screens/W088/
