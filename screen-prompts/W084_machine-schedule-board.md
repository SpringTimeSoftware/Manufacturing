...
This is screen completion prompt: W084 — Machine Schedule Board

Platform: Web
Module: Production
Primary roles: ProductionSupervisor, PlantHead
Business purpose: Lane view of what each machine is running next
...
- capture screenshots under docs/codex-review-screens/W084/

Required screenshots for this screen:
- w084-top
- w084-middle-if-needed
- w084-bottom-if-needed
