...
This is screen completion prompt: W025 — Shift Calendar

Platform: Web
Module: Organization
Primary roles: CompanyAdmin, ProductionSupervisor
Business purpose: Shift pattern, holidays, overtime calendars
...
- capture screenshots under docs/codex-review-screens/W025/

Required screenshots for this screen:
- w025-top
- w025-middle-if-needed
- w025-bottom-if-needed
