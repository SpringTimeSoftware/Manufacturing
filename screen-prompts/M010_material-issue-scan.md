...
This is screen completion prompt: M010 — Material Issue Scan

Platform: Mobile
Module: Inventory
Primary roles: StoreKeeper, ProductionSupervisor
Business purpose: Scan bin/barcode and issue to WO/job card
...
- capture screenshots under docs/codex-review-screens/M010/

Required screenshots for this screen:
- m010-screen-top
- m010-screen-lower-if-needed
