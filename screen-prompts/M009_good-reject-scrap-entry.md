...
This is screen completion prompt: M009 — Good / Reject / Scrap Entry

Platform: Mobile
Module: Production
Primary roles: MachineOperator, QCInspector
Business purpose: Quantity posting with photos and notes
...
- capture screenshots under docs/codex-review-screens/M009/

Required screenshots for this screen:
- m009-screen-top
- m009-screen-lower-if-needed
