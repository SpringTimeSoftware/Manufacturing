...
This is screen completion prompt: W114 — Executive Cockpit / Owner Dashboard

Platform: Web
Module: Dashboards
Primary roles: ManagementViewer
Business purpose: Single-screen truth across demand, production, quality, dispatch
...
- capture screenshots under docs/codex-review-screens/W114/

Required screenshots for this screen:
- w114-top
- w114-middle-if-needed
- w114-bottom-if-needed
