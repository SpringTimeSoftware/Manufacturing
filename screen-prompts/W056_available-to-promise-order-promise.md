...
This is screen completion prompt: W056 — Available to Promise / Order Promise

Platform: Web
Module: Sales
Primary roles: SalesCoordinator, PlanningManager
Business purpose: Committed date using material + capacity logic
...
- capture screenshots under docs/codex-review-screens/W056/
