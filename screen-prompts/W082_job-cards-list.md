...
This is screen completion prompt: W082 — Job Cards List

Platform: Web
Module: Production
Primary roles: ProductionSupervisor, MachineOperator
Business purpose: Execution list for operations and lot splits
...
- capture screenshots under docs/codex-review-screens/W082/

Required screenshots for this screen:
- w082-list-top
- w082-list-middle-if-needed
- w082-list-bottom-if-needed
