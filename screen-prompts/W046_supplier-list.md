...
This is screen completion prompt: W046 — Supplier List

Platform: Web
Module: Partners
Primary roles: PurchaseManager
Business purpose: Browse suppliers with lead-time and delay score
...
- capture screenshots under docs/codex-review-screens/W046/

Required screenshots for this screen:
- w046-list-top
- w046-list-middle-if-needed
- w046-list-bottom-if-needed
