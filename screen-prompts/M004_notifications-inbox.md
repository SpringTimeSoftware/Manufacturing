...
This is screen completion prompt: M004 — Notifications / Inbox

Platform: Mobile
Module: Platform
Primary roles: All users
Business purpose: Alerts, reminders, approvals, escalation messages
...
- capture screenshots under docs/codex-review-screens/M004/

Required screenshots for this screen:
- m004-screen-top
- m004-screen-lower-if-needed
