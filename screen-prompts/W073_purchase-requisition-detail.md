...
This is screen completion prompt: W073 — Purchase Requisition Detail

Platform: Web
Module: Procurement
Primary roles: PurchaseManager
Business purpose: Detail, approval, and conversion controls for PR
...
- capture screenshots under docs/codex-review-screens/W073/

Required screenshots for this screen:
- w073-workspace-overview
- w073-workspace-lower-if-needed
