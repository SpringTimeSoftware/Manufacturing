...
This is screen completion prompt: M012 — Bin Transfer / Putaway

Platform: Mobile
Module: Inventory
Primary roles: StoreKeeper
Business purpose: Move stock between bins/warehouses
...
- capture screenshots under docs/codex-review-screens/M012/

Required screenshots for this screen:
- m012-screen-top
- m012-screen-lower-if-needed
