...
This is screen completion prompt: M001 — Login

Platform: Mobile
Module: Platform
Primary roles: All users
Business purpose: Secure sign-in and device binding
...
- capture screenshots under docs/codex-review-screens/M001/

Required screenshots for this screen:
- m001-screen-top
- m001-screen-lower-if-needed
