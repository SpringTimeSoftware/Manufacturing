...
This is screen completion prompt: M024 — Settings / Sync Status / Language

Platform: Mobile
Module: Platform
Primary roles: All users
Business purpose: Offline queue, device info, language switch
...
1. Action truth
2. Field/control truth
3. Data truth
4. Security/role truth
5. Audit truth
...
- capture screenshots under docs/codex-review-screens/M024/

Required screenshots for this screen:
- m024-screen-top
- m024-screen-lower-if-needed
