...
This is screen completion prompt: W083 — Job Card Detail / Timeline Drawer

Platform: Web
Module: Production
Primary roles: ProductionSupervisor, MachineOperator
Business purpose: Start/pause/complete, quantities, downtime, timeline
...
- capture screenshots under docs/codex-review-screens/W083/

Required screenshots for this screen:
- w083-workspace-overview
- w083-workspace-lower-if-needed
