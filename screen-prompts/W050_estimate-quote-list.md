...
This is screen completion prompt: W050 — Estimate / Quote List

Platform: Web
Module: Sales
Primary roles: SalesCoordinator
Business purpose: Quote and cost estimate control for MTO/fabrication use cases
...
- capture screenshots under docs/codex-review-screens/W050/

Required screenshots for this screen:
- w050-list-top
- w050-list-middle-if-needed
- w050-list-bottom-if-needed
