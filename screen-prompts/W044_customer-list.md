...
This is screen completion prompt: W044 — Customer List

Platform: Web
Module: Partners
Primary roles: SalesCoordinator, ManagementViewer
Business purpose: Browse customers with delivery and order exposure
...
- No school-level list; governed filters/actions
...
- capture screenshots under docs/codex-review-screens/W044/

Required screenshots for this screen:
- w044-list-top
- w044-list-middle-if-needed
- w044-list-bottom-if-needed
