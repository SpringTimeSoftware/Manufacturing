...
This is screen completion prompt: W040 — Item List

Platform: Web
Module: Items
Primary roles: PlanningManager, StoreKeeper, SalesCoordinator
Business purpose: Search and filter all items with key status
...
- Determine all filter fields, KPI values, grid columns, row action fields, and selection-dependent controls from the current implementation and correct them using the global field truth rules.

Screen-specific actions to verify and complete:
- New item draft
- Import/Export
- Open item detail
- Upload media if real

Screen-specific additional notes:
- No dead top actions
- Filters compact and dense
...
- capture screenshots under docs/codex-review-screens/W040/

Required screenshots for this screen:
- w040-list-top
- w040-list-middle-if-needed
- w040-list-bottom-if-needed
