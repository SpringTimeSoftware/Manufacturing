...
This is screen completion prompt: M011 — Material Return Scan

Platform: Mobile
Module: Inventory
Primary roles: StoreKeeper, ProductionSupervisor
Business purpose: Scan and return unused material
...
- capture screenshots under docs/codex-review-screens/M011/

Required screenshots for this screen:
- m011-screen-top
- m011-screen-lower-if-needed
