...
This is screen completion prompt: W047 — Supplier Detail

Platform: Web
Module: Partners
Primary roles: PurchaseManager
Business purpose: Contacts, supply categories, terms, performance placeholders
...
- capture screenshots under docs/codex-review-screens/W047/

Required screenshots for this screen:
- w047-workspace-overview
- w047-workspace-lower-if-needed
