...
This is screen completion prompt: W081 — Work Order Detail / Drawer

Platform: Web
Module: Production
Primary roles: PlanningManager, ProductionSupervisor
Business purpose: Materials, operations, readiness, reservations, actions
...
- capture screenshots under docs/codex-review-screens/W081/

Required screenshots for this screen:
- w081-workspace-overview
- w081-workspace-lower-if-needed
