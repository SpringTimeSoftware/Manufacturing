...
This is screen completion prompt: W063 — ECO / Revision Control

Platform: Web
Module: Engineering
Primary roles: Engineering, CompanyAdmin
Business purpose: Approve and release revision changes with audit
...
2. Filters
3. Grid/tree
4. Revision/effectivity
5. Authoring actions
6. Audit/history

Screen-specific fields to verify and complete:
- change type
- affected BOM/routing/items
- status
...
- capture screenshots under docs/codex-review-screens/W063/
