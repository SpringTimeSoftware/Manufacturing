...
This is screen completion prompt: W001 — Login

Platform: Web
Module: Platform
Primary roles: All users
Business purpose: Secure sign-in with company/branch context and device registration
...
- username/email
- password
- company/branch context if required
- remember me / device binding if supported

Screen-specific actions to verify and complete:
- Sign in
- Forgot password
- Open demo only if explicitly intended
- Sign out/clear stale session truth

Screen-specific additional notes:
- No internal/scaffold wording
- Handle stale token cleanly
- No fake demo/live confusion
...
- capture screenshots under docs/codex-review-screens/W001/
