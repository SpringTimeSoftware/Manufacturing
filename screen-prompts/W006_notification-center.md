...
This is screen completion prompt: W006 — Notification Center

Platform: Web
Module: Platform
Primary roles: All roles
Business purpose: System alerts, approvals, and reminder inbox
...
- Mark read
- Open linked record
- Bulk dismiss if supported

Screen-specific additional notes:
- No silent seeded fallback in live mode
...
- capture screenshots under docs/codex-review-screens/W006/
