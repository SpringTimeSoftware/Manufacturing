...
This is screen completion prompt: W051 — Sales Order List

Platform: Web
Module: Sales
Primary roles: SalesCoordinator, PlanningManager
Business purpose: Entry point to manufacturing demand
...
- capture screenshots under docs/codex-review-screens/W051/

Required screenshots for this screen:
- w051-list-top
- w051-list-middle-if-needed
- w051-list-bottom-if-needed
