...
This is screen completion prompt: M003 — My Dashboard

Platform: Mobile
Module: Dashboards
Primary roles: All users
Business purpose: Role-specific action cards and summary tiles
...
- capture screenshots under docs/codex-review-screens/M003/

Required screenshots for this screen:
- m003-screen-top
- m003-screen-lower-if-needed
