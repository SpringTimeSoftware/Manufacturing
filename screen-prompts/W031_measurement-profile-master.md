...
This is screen completion prompt: W031 — Measurement Profile Master

Platform: Web
Module: Measurements
Primary roles: CompanyAdmin
Business purpose: Profiles for count-only, catch-weight, dimensional items
...
- capture screenshots under docs/codex-review-screens/W031/
