...
This is screen completion prompt: W072 — Purchase Requisition List

Platform: Web
Module: Procurement
Primary roles: PurchaseManager, PlanningManager
Business purpose: List and approve purchase requisitions created from planning or manual demand
...
- capture screenshots under docs/codex-review-screens/W072/

Required screenshots for this screen:
- w072-list-top
- w072-list-middle-if-needed
- w072-list-bottom-if-needed
