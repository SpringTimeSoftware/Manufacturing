...
This is screen completion prompt: W052 — Sales Order Detail

Platform: Web
Module: Sales
Primary roles: SalesCoordinator, PlanningManager
Business purpose: Order lines, promise dates, specs, attachments, make type
...
- capture screenshots under docs/codex-review-screens/W052/

Required screenshots for this screen:
- w052-workspace-overview
- w052-workspace-lower-if-needed
