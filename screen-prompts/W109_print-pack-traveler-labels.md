...
This is screen completion prompt: W109 — Print Pack / Traveler / Labels

Platform: Web
Module: Reports
Primary roles: ProductionSupervisor, StoreKeeper, DispatchManager
Business purpose: Printable job travelers, labels, checklists, summaries
...
1. Filter/parameter workspace
2. Preview/export/print truth
3. Audit/history
...
- capture screenshots under docs/codex-review-screens/W109/
