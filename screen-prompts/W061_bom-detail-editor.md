...
This is screen completion prompt: W061 — BOM Detail / Editor

Platform: Web
Module: Engineering
Primary roles: PlanningManager, Engineering
Business purpose: Tree view editor for components, scrap%, issue method, operations
...
- capture screenshots under docs/codex-review-screens/W061/

Required screenshots for this screen:
- w061-workspace-overview
- w061-workspace-lower-if-needed
