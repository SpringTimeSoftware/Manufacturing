...
This is screen completion prompt: W041 — Item Detail / Editor

Platform: Web
Module: Items
Primary roles: CompanyAdmin, PlanningManager
Business purpose: Full item master including measurement, stock, QC, costing placeholders
...
- All governed fields must be lookup/select; weights numeric; upload truthful
...
- capture screenshots under docs/codex-review-screens/W041/

Required screenshots for this screen:
- w041-workspace-overview
- w041-workspace-lower-if-needed
