...
This is screen completion prompt: W057 — Order Delivery Dashboard

Platform: Web
Module: Dashboards
Primary roles: ManagementViewer, SalesCoordinator, PlantHead
Business purpose: Customer-order risk view with progress % and next actions
...
- capture screenshots under docs/codex-review-screens/W057/

Required screenshots for this screen:
- w057-top
- w057-middle-if-needed
- w057-bottom-if-needed
