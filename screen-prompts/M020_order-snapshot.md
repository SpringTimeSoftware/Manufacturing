...
This is screen completion prompt: M020 — Order Snapshot

Platform: Mobile
Module: Dashboards
Primary roles: ManagementViewer, SalesCoordinator
Business purpose: Mobile order health summary
...
- capture screenshots under docs/codex-review-screens/M020/

Required screenshots for this screen:
- m020-screen-top
- m020-screen-lower-if-needed
