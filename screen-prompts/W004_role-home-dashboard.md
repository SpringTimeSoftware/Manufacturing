...
This is screen completion prompt: W004 — Role Home Dashboard

Platform: Web
Module: Dashboards
Primary roles: All roles
Business purpose: First landing page with role-specific action cards and KPIs
...
- Determine every visible field in this screen/workspace from the current implementation and correct control type, validation, dependencies, and editability using the global field truth rules.

Screen-specific actions to verify and complete:
- Open primary workflows
- Open notifications/approvals
- Open role-specific shortcuts

Screen-specific additional notes:
- No fake KPI cards
- No seeded operational fallback in live mode
...
- capture screenshots under docs/codex-review-screens/W004/

Required screenshots for this screen:
- w004-top
- w004-middle-if-needed
- w004-bottom-if-needed
