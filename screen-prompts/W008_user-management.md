...
This is screen completion prompt: W008 — User Management

Platform: Web
Module: Platform
Primary roles: PlatformAdmin, CompanyAdmin
Business purpose: Manage users, status, login policies, branch access
...
- capture screenshots under docs/codex-review-screens/W008/
