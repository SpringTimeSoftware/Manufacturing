...
5. `ddl/00-foundation/011_platform_udf_customization_completion.sql`
6. `ddl/10-master-data/010_master_resource_engineering_tables.sql`
7. `ddl/10-master-data/020_item_master_v2_extension_tables.sql`
8. `ddl/10-master-data/030_partner_master_v2_extension_tables.sql`
9. `ddl/10-master-data/040_item_attribute_value_set_tables.sql`
10. `ddl/20-commercial/010_sales_planning_procurement_inventory_tables.sql`
11. `ddl/20-commercial/020_commercial_master_v2_tables.sql`
12. `ddl/20-commercial/040_procure_to_pay_sourcing_tables.sql`
13. `ddl/20-commercial/050_planning_mrp_boq_capacity_completion_tables.sql`
14. `ddl/20-commercial/060_sales_commercial_contract_hardening.sql`
15. `ddl/20-commercial/070_customer_commercial_assignment_sales_owner.sql`
16. `ddl/20-commercial/080_inventory_tracking_policy_snapshot_hardening.sql`
17. `ddl/00-foundation/009_production_execution_tables.sql`
18. `ddl/00-foundation/010_production_quality_dispatch_tables.sql`
19. `ddl/20-commercial/090_quality_ncr_coa_completion.sql`
20. `ddl/20-commercial/100_dispatch_logistics_pod_completion.sql`
21. `ddl/20-commercial/110_finance_gl_ap_ar_costing_completion.sql`
22. `ddl/20-commercial/130_reports_dashboard_builder_completion.sql`
...
- platform extensibility UDF definitions, placements, typed values, value history, custom objects, and governed custom screens with audit-ready company scoping;
