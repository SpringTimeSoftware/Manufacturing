# P102 — Capacity planning board

## Phase
Phase 5 - Web Screens

## Objective
Build the capacity planning board in the React web application.
...
## Work to do
- Implement the following related web screens: W069 Capacity Planning Board.
...
- W069 — RCCP/CRP by machine/work center/shift

## Related screens

| ScreenId | Name | Roles | Purpose | ReferenceUI |
| --- | --- | --- | --- | --- |
| W069 | Capacity Planning Board | PlanningManager, PlantHead | RCCP/CRP by machine/work center/shift |  |
...
- Next prompt: `/02-prompts/P103_purchase-requisition-list-detail-screens.md`
