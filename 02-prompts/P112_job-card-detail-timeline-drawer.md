# P112 — Job card detail / timeline drawer

## Phase
Phase 5 - Web Screens

## Objective
Build the job card detail / timeline drawer in the React web application.
...
## Work to do
- Implement the following related web screens: W083 Job Card Detail / Timeline Drawer.
...
- W083 — Start/pause/complete, quantities, downtime, timeline

## Related screens

| ScreenId | Name | Roles | Purpose | ReferenceUI |
| --- | --- | --- | --- | --- |
| W083 | Job Card Detail / Timeline Drawer | ProductionSupervisor, MachineOperator | Start/pause/complete, quantities, downtime, timeline | W082_Job_Cards.html |
...
- Next prompt: `/02-prompts/P113_machine-schedule-board.md`
