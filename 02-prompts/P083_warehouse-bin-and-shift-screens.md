# P083 — Warehouse, bin, and shift screens

## Phase
Phase 5 - Web Screens

## Objective
Build the warehouse, bin, and shift screens in the React web application.
...
## Work to do
- Implement the following related web screens: W023 Warehouse Master, W024 Bin Master, W025 Shift Calendar.
...
- W023 — Warehouse types, branch mapping, WIP/FG/RM tagging
- W024 — Row/rack/bin structure, capacity, quarantine bins
- W025 — Shift pattern, holidays, overtime calendars

## Related screens

| ScreenId | Name | Roles | Purpose | ReferenceUI |
| --- | --- | --- | --- | --- |
| W023 | Warehouse Master | CompanyAdmin, StoreKeeper | Warehouse types, branch mapping, WIP/FG/RM tagging |  |
| W024 | Bin Master | CompanyAdmin, StoreKeeper | Row/rack/bin structure, capacity, quarantine bins |  |
| W025 | Shift Calendar | CompanyAdmin, ProductionSupervisor | Shift pattern, holidays, overtime calendars |  |
...
- Next prompt: `/02-prompts/P084_uom-class-and-conversion-screens.md`
