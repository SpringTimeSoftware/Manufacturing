# P098 — Routing and operation standard screens

## Phase
Phase 5 - Web Screens

## Objective
Build the routing and operation standard screens in the React web application.
...
## Work to do
- Implement the following related web screens: W064 Routing Library, W065 Operation Standard & Cycle Times.
...
- W064 — Reusable routings and operation sequences
- W065 — Setup, run, teardown, overlap, skill and QC flags

## Related screens

| ScreenId | Name | Roles | Purpose | ReferenceUI |
| --- | --- | --- | --- | --- |
| W064 | Routing Library | PlanningManager | Reusable routings and operation sequences |  |
| W065 | Operation Standard & Cycle Times | PlanningManager | Setup, run, teardown, overlap, skill and QC flags |  |

## Deliverables for this prompt
- `/docs/codex-progress/P098-output.md`
...
- Next prompt: `/02-prompts/P099_alternate-item-rules-and-engineering-attachment-surfaces.md`
