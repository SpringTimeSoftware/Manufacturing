# P085 — Measurement profile and dimensional formula screens

## Phase
Phase 5 - Web Screens

## Objective
Build the measurement profile and dimensional formula screens in the React web application.
...
## Work to do
- Implement the following related web screens: W031 Measurement Profile Master.
...
- W031 — Profiles for count-only, catch-weight, dimensional items

## Related screens

| ScreenId | Name | Roles | Purpose | ReferenceUI |
| --- | --- | --- | --- | --- |
| W031 | Measurement Profile Master | CompanyAdmin | Profiles for count-only, catch-weight, dimensional items |  |

## Deliverables for this prompt
- `/docs/codex-progress/P085-output.md`
...
- Next prompt: `/02-prompts/P086_item-group-attribute-and-reason-code-master-screens.md`
