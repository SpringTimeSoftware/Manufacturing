# P096 — BOM detail and editor screen

## Phase
Phase 5 - Web Screens

## Objective
Build the bom detail and editor screen in the React web application.
...
- `/00-blueprint/screen_inventory.csv`
- `/reference-ui/W060_BOM_Management.html`

## Work to do
- Implement the following related web screens: W061 BOM Detail / Editor.
...
- Use /reference-ui/W060_BOM_Management.html as the visual anchor for layout, spacing, card style, badges, and screen composition.
## User-value notes

- W061 — Tree view editor for components, scrap%, issue method, operations

## Related screens

| ScreenId | Name | Roles | Purpose | ReferenceUI |
| --- | --- | --- | --- | --- |
| W061 | BOM Detail / Editor | PlanningManager, Engineering | Tree view editor for components, scrap%, issue method, operations | W060_BOM_Management.html |

## Deliverables for this prompt
- `/docs/codex-progress/P096-output.md`
...
- Next prompt: `/02-prompts/P097_bom-comparison-and-eco-screens.md`
