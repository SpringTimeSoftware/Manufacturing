...
## Objective
Build the mobile polish, performance, localization, and role-aware navigation in the React Native mobile app.
...
## Work to do
- Implement the following mobile surfaces: M003 My Dashboard, M024 Settings / Sync Status / Language.
...
- `/docs/codex-progress/P137-output.md`
...
- Next prompt: `/02-prompts/P138_email-sms-and-whatsapp-provider-abstractions.md`
