# P090 — Supplier lead-time matrix and attachment viewer

## Phase
Phase 5 - Web Screens

## Objective
Build the supplier lead-time matrix and attachment viewer in the React web application.
...
## Work to do
- Implement the following related web screens: W048 Supplier Lead Time Matrix, W049 Attachment / Document Viewer.
...
- W048 — Lead time by item/category/branch
...
| --- | --- | --- | --- | --- |
| W048 | Supplier Lead Time Matrix | PurchaseManager, PlanningManager | Lead time by item/category/branch |  |
| W049 | Attachment / Document Viewer | All roles | View drawings, PDFs, photos linked to documents |  |

## Deliverables for this prompt
- `/docs/codex-progress/P090-output.md`
...
- Next prompt: `/02-prompts/P091_quote-estimate-list-and-detail-screens.md`
