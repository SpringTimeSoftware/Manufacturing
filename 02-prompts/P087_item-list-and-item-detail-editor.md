# P087 — Item list and item detail editor

## Phase
Phase 5 - Web Screens

## Objective
Build the item list and item detail editor in the React web application.
...
## Work to do
- Implement the following related web screens: W040 Item List, W041 Item Detail / Editor.
...
- W040 — Search and filter all items with key status
- W041 — Full item master including measurement, stock, QC, costing placeholders

## Related screens

| ScreenId | Name | Roles | Purpose | ReferenceUI |
| --- | --- | --- | --- | --- |
| W040 | Item List | PlanningManager, StoreKeeper, SalesCoordinator | Search and filter all items with key status |  |
| W041 | Item Detail / Editor | CompanyAdmin, PlanningManager | Full item master including measurement, stock, QC, costing placeholders |  |

## Deliverables for this prompt
- `/docs/codex-progress/P087-output.md`
...
- Next prompt: `/02-prompts/P088_item-variants-and-barcode-screens.md`
