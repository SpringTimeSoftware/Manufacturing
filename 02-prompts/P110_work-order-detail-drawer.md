# P110 — Work order detail / drawer

## Phase
Phase 5 - Web Screens

## Objective
Build the work order detail / drawer in the React web application.
...
## Work to do
- Implement the following related web screens: W081 Work Order Detail / Drawer.
...
- W081 — Materials, operations, readiness, reservations, actions

## Related screens

| ScreenId | Name | Roles | Purpose | ReferenceUI |
| --- | --- | --- | --- | --- |
| W081 | Work Order Detail / Drawer | PlanningManager, ProductionSupervisor | Materials, operations, readiness, reservations, actions | W080_Work_Orders.html |
...
- Next prompt: `/02-prompts/P111_job-cards-list-screen.md`
