# P108 — Cycle count screen

## Phase
Phase 5 - Web Screens

## Objective
Build the cycle count screen in the React web application.
...
## Work to do
- Implement the following related web screens: W096 Cycle Count.
...
- W096 — Count sheets, variances, approvals

## Related screens

| ScreenId | Name | Roles | Purpose | ReferenceUI |
| --- | --- | --- | --- | --- |
| W096 | Cycle Count | StoreKeeper | Count sheets, variances, approvals |  |
...
- Next prompt: `/02-prompts/P109_work-orders-list-screen.md`
