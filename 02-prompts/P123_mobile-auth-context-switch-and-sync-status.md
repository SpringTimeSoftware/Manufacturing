# P123 — Mobile auth, context switch, and sync status

## Phase
Phase 6 - Mobile

## Objective
Build the mobile auth, context switch, and sync status in the React Native mobile app.
...
## Work to do
- Implement the following mobile surfaces: M001 Login, M002 Company / Branch Select, M024 Settings / Sync Status / Language.
...
| M002 | Company / Branch Select | All users | Switch operating context |  |
| M024 | Settings / Sync Status / Language | All users | Offline queue, device info, language switch |  |

## Deliverables for this prompt
- `/docs/codex-progress/P123-output.md`
...
- Next prompt: `/02-prompts/P124_mobile-home-dashboard-notifications-and-approvals.md`
