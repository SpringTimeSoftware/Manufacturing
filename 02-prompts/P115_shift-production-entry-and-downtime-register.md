# P115 — Shift production entry and downtime register

## Phase
Phase 5 - Web Screens

## Objective
Build the shift production entry and downtime register in the React web application.
...
## Work to do
- Implement the following related web screens: W091 Shift Production Entry, W092 Downtime Register.
...
- W091 — Summarize shift output and issues
- W092 — All downtime events with reasons and machine impact

## Related screens

| ScreenId | Name | Roles | Purpose | ReferenceUI |
| --- | --- | --- | --- | --- |
| W091 | Shift Production Entry | ProductionSupervisor | Summarize shift output and issues |  |
| W092 | Downtime Register | ProductionSupervisor, PlantHead | All downtime events with reasons and machine impact |  |
...
- Next prompt: `/02-prompts/P116_production-receipt-and-scrap-by-product-screens.md`
