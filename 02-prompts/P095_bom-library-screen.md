# P095 — BOM library screen

## Phase
Phase 5 - Web Screens

## Objective
Build the bom library screen in the React web application.
...
## Work to do
- Implement the following related web screens: W060 BOM Library.
...
- W060 — Search revisions and statuses of BOMs

## Related screens

| ScreenId | Name | Roles | Purpose | ReferenceUI |
| --- | --- | --- | --- | --- |
| W060 | BOM Library | PlanningManager, Engineering, PlantHead | Search revisions and statuses of BOMs | W060_BOM_Management.html |

## Deliverables for this prompt
- `/docs/codex-progress/P095-output.md`
...
- Next prompt: `/02-prompts/P096_bom-detail-and-editor-screen.md`
