# P130 — QC checkpoint and NCR capture flows

## Phase
Phase 6 - Mobile

## Objective
Build the qc checkpoint and ncr capture flows in the React Native mobile app.
...
## Work to do
- Implement the following mobile surfaces: M016 QC Checkpoint Entry, M018 Rework / NCR Capture.
...
- M016 — Pass/fail/measurement/photo capture
...
| --- | --- | --- | --- | --- |
| M016 | QC Checkpoint Entry | QCInspector, ProductionSupervisor | Pass/fail/measurement/photo capture |  |
| M018 | Rework / NCR Capture | QCInspector, ProductionSupervisor | Create deviation, hold, rework instruction |  |

## Deliverables for this prompt
- `/docs/codex-progress/P130-output.md`
...
- Next prompt: `/02-prompts/P131_production-receipt-scrap-and-rework-flows.md`
