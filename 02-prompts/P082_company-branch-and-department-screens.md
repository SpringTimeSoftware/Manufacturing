# P082 — Company, branch, and department screens

## Phase
Phase 5 - Web Screens

## Objective
Build the company, branch, and department screens in the React web application.
...
## Work to do
- Implement the following related web screens: W020 Company Master, W021 Branch Master, W022 Department Master.
...
- W020 — Legal entities, tax/basic info, branding, working calendar
- W021 — Plants/branches, timezone, default warehouse, contacts
- W022 — Sales, planning, production, QC, stores, dispatch etc.

## Related screens

| ScreenId | Name | Roles | Purpose | ReferenceUI |
| --- | --- | --- | --- | --- |
| W020 | Company Master | CompanyAdmin | Legal entities, tax/basic info, branding, working calendar |  |
| W021 | Branch Master | CompanyAdmin | Plants/branches, timezone, default warehouse, contacts |  |
| W022 | Department Master | CompanyAdmin | Sales, planning, production, QC, stores, dispatch etc. |  |

## Deliverables for this prompt
- `/docs/codex-progress/P082-output.md`
...
- Next prompt: `/02-prompts/P083_warehouse-bin-and-shift-screens.md`
