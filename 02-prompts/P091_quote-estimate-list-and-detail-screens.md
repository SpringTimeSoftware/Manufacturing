# P091 — Quote / estimate list and detail screens

## Phase
Phase 5 - Web Screens

## Objective
Build the quote / estimate list and detail screens in the React web application.
...
## Work to do
- Implement the following related web screens: W050 Estimate / Quote List.
...
- W050 — Quote and cost estimate control for MTO/fabrication use cases

## Related screens

| ScreenId | Name | Roles | Purpose | ReferenceUI |
| --- | --- | --- | --- | --- |
| W050 | Estimate / Quote List | SalesCoordinator | Quote and cost estimate control for MTO/fabrication use cases |  |

## Deliverables for this prompt
- `/docs/codex-progress/P091-output.md`
...
- Next prompt: `/02-prompts/P092_sales-order-list-and-detail-screens.md`
