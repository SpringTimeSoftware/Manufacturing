# P116 — Production receipt and scrap/by-product screens

## Phase
Phase 5 - Web Screens

## Objective
Build the production receipt and scrap/by-product screens in the React web application.
...
## Work to do
- Implement the following related web screens: W088 Production Receipt, W089 Scrap / By-product Entry.
...
- W088 — Receive WIP/FG output with lot/serial/catch-weight handling
- W089 — Capture scrap, by-product, reason, valuation placeholders

## Related screens

| ScreenId | Name | Roles | Purpose | ReferenceUI |
| --- | --- | --- | --- | --- |
| W088 | Production Receipt | ProductionSupervisor, StoreKeeper | Receive WIP/FG output with lot/serial/catch-weight handling |  |
| W089 | Scrap / By-product Entry | ProductionSupervisor | Capture scrap, by-product, reason, valuation placeholders |  |

## Deliverables for this prompt
- `/docs/codex-progress/P116-output.md`
...
- Next prompt: `/02-prompts/P117_rework-order-and-machine-status-screen.md`
