# P114 — PPS machine occupancy calendar

## Phase
Phase 5 - Web Screens

## Objective
Build the pps machine occupancy calendar in the React web application.
...
## Work to do
- Implement the following related web screens: W085 PPS Machine Occupancy Calendar.
...
- Use /reference-ui/W085_PPS_Machine_Occupancy_Calendar.html as the visual anchor for layout, spacing, card style, badges, and screen composition.
## User-value notes

- W085 — Calendar occupancy across machines and days

## Related screens

| ScreenId | Name | Roles | Purpose | ReferenceUI |
| --- | --- | --- | --- | --- |
| W085 | PPS Machine Occupancy Calendar | PlanningManager, PlantHead | Calendar occupancy across machines and days | W085_PPS_Machine_Occupancy_Calendar.html |
...
- Next prompt: `/02-prompts/P115_shift-production-entry-and-downtime-register.md`
