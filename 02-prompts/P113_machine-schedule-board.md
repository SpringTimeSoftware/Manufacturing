# P113 — Machine schedule board

## Phase
Phase 5 - Web Screens

## Objective
Build the machine schedule board in the React web application.
...
## Work to do
- Implement the following related web screens: W084 Machine Schedule Board.
...
- Use /reference-ui/W084_Machine_Schedule_Board.html as the visual anchor for layout, spacing, card style, badges, and screen composition.
## User-value notes

- W084 — Lane view of what each machine is running next

## Related screens

| ScreenId | Name | Roles | Purpose | ReferenceUI |
| --- | --- | --- | --- | --- |
| W084 | Machine Schedule Board | ProductionSupervisor, PlantHead | Lane view of what each machine is running next | W084_Machine_Schedule_Board.html |
...
- Next prompt: `/02-prompts/P114_pps-machine-occupancy-calendar.md`
