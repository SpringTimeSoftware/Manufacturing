# P105 — Inventory balance and traceability screens

## Phase
Phase 5 - Web Screens

## Objective
Build the inventory balance and traceability screens in the React web application.
...
## Work to do
- Implement the following related web screens: W094 Inventory Balance by Warehouse / Bin, W097 Lot / Serial / Catch Weight Traceability.
...
- W094 — Real-time stock, reserved, QC-hold, blocked
- W097 — Forward/backward traceability by lot, serial, order

## Related screens

| ScreenId | Name | Roles | Purpose | ReferenceUI |
| --- | --- | --- | --- | --- |
| W094 | Inventory Balance by Warehouse / Bin | StoreKeeper, PlanningManager | Real-time stock, reserved, QC-hold, blocked |  |
| W097 | Lot / Serial / Catch Weight Traceability | QCInspector, StoreKeeper, ManagementViewer | Forward/backward traceability by lot, serial, order |  |
...
- Next prompt: `/02-prompts/P106_material-issue-screen.md`
