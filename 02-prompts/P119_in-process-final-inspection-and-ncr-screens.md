# P119 — In-process/final inspection and NCR screens

## Phase
Phase 5 - Web Screens

## Objective
Build the in-process/final inspection and ncr screens in the React web application.
...
## Work to do
- Implement the following related web screens: W102 In-Process Inspection, W103 Final Inspection, W104 NCR / Deviation.
...
- W102 — Checkpoint results against operation/job card
- W103 — Final quality release before dispatch or FG transfer
- W104 — Non-conformance, hold, decision, rework linkage

## Related screens

| ScreenId | Name | Roles | Purpose | ReferenceUI |
| --- | --- | --- | --- | --- |
| W102 | In-Process Inspection | QCInspector, ProductionSupervisor | Checkpoint results against operation/job card |  |
| W103 | Final Inspection | QCInspector | Final quality release before dispatch or FG transfer |  |
| W104 | NCR / Deviation | QCInspector, PlantHead | Non-conformance, hold, decision, rework linkage |  |

## Deliverables for this prompt
- `/docs/codex-progress/P119-output.md`
...
- Next prompt: `/02-prompts/P120_pack-list-dispatch-planning-and-shipment-screens.md`
