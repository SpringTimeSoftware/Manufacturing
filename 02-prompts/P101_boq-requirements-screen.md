# P101 — BOQ / requirements screen

## Phase
Phase 5 - Web Screens

## Objective
Build the boq / requirements screen in the React web application.
...
- `/00-blueprint/screen_inventory.csv`
- `/reference-ui/W066_BOQ_Requirements.html`

## Work to do
- Implement the following related web screens: W066 BOQ / Requirements.
...
- Use /reference-ui/W066_BOQ_Requirements.html as the visual anchor for layout, spacing, card style, badges, and screen composition.
## User-value notes

- W066 — Net requirements after explosion and stock netting with action overrides

## Related screens

| ScreenId | Name | Roles | Purpose | ReferenceUI |
| --- | --- | --- | --- | --- |
| W066 | BOQ / Requirements | PlanningManager, PurchaseManager | Net requirements after explosion and stock netting with action overrides | W066_BOQ_Requirements.html |

## Deliverables for this prompt
- `/docs/codex-progress/P101-output.md`
...
- Next prompt: `/02-prompts/P102_capacity-planning-board.md`
