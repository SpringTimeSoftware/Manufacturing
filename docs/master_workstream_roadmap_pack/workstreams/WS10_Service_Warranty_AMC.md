...
Post-sales service, warranty, AMC, RMA, service dashboard.

## Scope keywords

service ticket, complaint, warranty, serial, AMC contract, service job, spare issue, RMA, repair, service dashboard.
...
- Complete service call/complaint registration.
- Complete warranty lookup by serial/lot/customer/item.
- Complete AMC contract and entitlement checks.
- Complete service visit/task lifecycle.
- Complete spare part issue/return.
- Complete RMA/repair/replacement flow.
- Complete customer-facing service status/dashboard if exposed.
...
- create/update the workstream matrix under `docs/workstream-progress/WS10/`.
...
Capture screenshots under `docs/codex-review-screens/WS10/`.
If a screen scrolls, capture max top/middle/bottom.

### Phase F — Final output
Create:
- `docs/codex-progress/WS10-output.md`
