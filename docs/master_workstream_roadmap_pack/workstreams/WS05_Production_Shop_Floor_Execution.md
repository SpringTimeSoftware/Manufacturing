...
Work order/job card/material issue/labor/machine/receipt/rework depth.

## Scope keywords

work orders, job cards, material issue, labor booking, machine booking, downtime, production receipt, scrap, rework, WIP.
...
- Complete work order lifecycle: draft, released, in-progress, on-hold, closed.
- Complete material issue/return to production with warehouse/bin/lot checks.
- Complete job card assignment, start, pause, resume, complete, quantity capture.
- Complete labor/machine booking and downtime effects.
- Complete production completion / FG receipt / scrap / rework.
- Complete subcontracting order flow where exposed.
- Verify WIP valuation truth or hide/disable cost widgets.
...
- create/update the workstream matrix under `docs/workstream-progress/WS05/`.
...
Capture screenshots under `docs/codex-review-screens/WS05/`.
If a screen scrolls, capture max top/middle/bottom.

### Phase F — Final output
Create:
- `docs/codex-progress/WS05-output.md`
