...
Master data, resources, pricing/tax/terms truth.

## Scope keywords

item, customer, supplier, item groups, UOM, measurement, resources, work centers, machines, price lists, discounts, tax, currency, terms.
...
- Complete Item Master with taxonomy, UOM, packaging, physical specs, media, catalog, planning, inventory, quality, commercial, vendor/customer references, audit.
- Complete customer/supplier sites, contacts, terms, credit, compliance, documents, and audit.
- Complete resources: work centers, machines, tools, operators, shifts.
- Complete price lists, price lines, discounts, tax, currency, payment terms, trade terms.
- Verify item category/subcategory/product family/business segment/reporting bucket are governed selectors, not text.
- Verify net/gross weight/dimensions are numeric.
- Verify media upload is real or disabled with reason.
...
- create/update the workstream matrix under `docs/workstream-progress/WS03/`.
...
Capture screenshots under `docs/codex-review-screens/WS03/`.
If a screen scrolls, capture max top/middle/bottom.

### Phase F — Final output
Create:
- `docs/codex-progress/WS03-output.md`
