...
Release, performance, backup/restore, final UAT, security and pilot gates.

## Scope keywords

final role-wise UAT, performance, security, deployment, backup restore, release notes, known backlog.
...
- Complete final role-wise UAT.
- Complete security hardening and rate-limit review.
- Complete performance smoke tests for dashboards/reports/lists.
- Complete accessibility and responsive checks.
- Complete backup/restore and deployment recovery runbooks.
- Complete final release notes, known backlog, pilot scope, and acceptance signoff.
...
- create/update the workstream matrix under `docs/workstream-progress/WS11/`.
...
Capture screenshots under `docs/codex-review-screens/WS11/`.
